...
<el-row style="z-index:999;">
 ...
 <div class="main" >
  ...
  <el-button size="small"  :plain="true" ref="appbtn" type="info" class="btn"  :style="{'right':rightoff}"  @click="formatLayout"><i class="el-icon-setting"></i></el-button>
  <el-card class="box-card" :style="{'right':rightoffset}" >
  <div slot="header" class="clearfix">
    <span class="text-title">COSTOMIZE</span><br/><span class="text-xs">自定义Nifty的布局，侧边栏和配色方案。</span>
    <el-button style="float: right;font-size: 25px; margin-top:-30px" type="text" icon="el-icon-circle-close-outline" @click="formatLayout"></el-button>
  </div>
  <el-row :gutter="40">
    <el-col :span="6">
    <div class="grid-content bg-purple">
      ...
      <div class="text-div mar-btm">
        <span>背景图片<i class="el-icon-info"></i></span>
        <el-switch
  ...
  <el-col :span="6" style="background:#f8f9fa;" v-if="!this.isbgasidecolor">
    <div style="height:20px;width:117%;margin-top:-20px;margin-left: -20px;background:#f8f9fa;"></div>
    <div class="grid-content bg-purple">
   ...
   <el-col :span="12" v-if="!this.isbgasidecolor">
    <div class="grid-content bg-purple">
      ...
      <el-row class="monder">
        <el-col :span="24" class="monder-title"><span class="text-xs">现代</span></el-col>
        <el-row :gutter="10">
          <el-col :xs="13" :sm="13" :md="7" :lg="7" :xl="7"><img src="../../assets/color-schemes-e.png"/></el-col>
        ...
        <el-col :xs="12" :sm="12" :md="6" :lg="6" :xl="6" class="schemes">
          ...
          <div class="demo-diversify-theme">
             ...
             <!--  <a href="#" class="demo-theme-make demo-theme-gray"></a>
              ...
              <a href="#" class="demo-theme-make demo-theme-ocean"></a>
              <a href="#" class="demo-theme-make demo-theme-lime"></a>
              <a href="#" class="demo-theme-make demo-theme-purple"></a>
              <a href="#" class="demo-theme-make demo-theme-dust"></a>
              <a href="#" class="demo-theme-make demo-theme-mint"></a>
              <a href="#" class="demo-theme-make demo-theme-yellow"></a>
              <a href="#" class="demo-theme-make demo-theme-well-red"></a>
              <a href="#" class="demo-theme-make demo-theme-coffee"></a>
              <a href="#" class="demo-theme-make demo-theme-prickly-pear"></a>
              <a href="#" class="demo-theme-make demo-theme-dark"></a> -->
            </div>
        </el-col>
        <el-col :xs="12" :sm="12" :md="6" :lg="6" :xl="6" class="schemes">
...
export default {
 ...
 computed:{
  ...
  //   },
  //   set(newValue) {
  //   this.$store.getters.boxlay.backgroundImg = newValue;
  // }
  // },
  isCollapse() {
...
.mark{position:fixed;
 ...
 .btn{position: fixed;right: -10px; top: 50%; z-index: 3; font-size: 25px;}
 .box-card{position: fixed;right: -3500px; top: 3%; z-index: 3}
 .box-card[data-v-33b77da8] {
    width: 81% !important;
    max-height: 96% !important;
    overflow-y: scroll !important;
}
.schemes{height:208px;}
.el-card__header {
...
.text-div{font-size: 13px;color:#7a878e}
.el-switch{float: right;}
.mar-btm{margin: 13px 0px 16px 0px}
.mar-btmm{margin: 38px 0px 12px 0px}
hr{background: #ebeef5;height: 1px; border: none}
.theme-text{margin:10px 0px 0px 20px}
.demo-single-theme{width: 40px;height:29px;border: 1px solid #ddd!important; margin: 15px 10px 0px 10px}
.demo-theme-light{background: #fff;}
.theme-dark{background: #3a444e;}
.monder{background: #f8f9fa;margin:20px 0px 20px 0px;padding:10px}
.monder-title{padding:0px 0px 0px 20%;margin: 5px 0px 15px 0px}
...
.bag{margin-bottom: 40px;}
.bag-big{background: #f8f9fa;}
.bag-div{background: #f8f9fa;height: 20px;width: 117%;margin-left: -20px;margin-top: -20px;}
.btnclose{margin-top: 10px; color: #fafafb;
    background: #25476a;
    border-color: #25476a;}
.demo-theme-gray{
    background: #8f9ea6;
