    ...
    <el-col :span="24" class="btns">
	 ...
	 <el-button type="danger" size="mini" icon="el-icon-delete" @click="batchRemove" :disabled="this.sels.length===0">批量删除</el-button>
		...
		<el-table :data="users" highlight-current-row border="true" resizable v-loading="listLoading" @selection-change="selsChange" :default-sort = "{prop: 'birth', order: 'descending'}" style="width: 100%; margin: 7px 0px 0px 0px;">
			...
			<el-table-column label="操作" >
				<template scope="scope">
                    <el-button type="success" size="small" @click="handleSelect(scope.$index, scope.row)">查看</el-button>
		...
		<el-dialog title="编辑" :visible.syn="editFormVisible" @close="editFormVisible=false">
			...
			<el-form :model="editForm" label-width="100px" :rules="editFormRules" ref="editForm" disabled="true">
				<el-form-item :label="type_name" prop="name">
					<el-input v-model="editForm.name" auto-complete="off"></el-input>
				</el-form-item>
                <el-form-item :label="remark">
